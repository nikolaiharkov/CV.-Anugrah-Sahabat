            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">List Portofolio</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <a href="tambah_portofolio.php" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Tambah Portofolio</a>
                                <br><br>
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td><img src="assets/portofolio/<?php echo $row['foto']; ?>" width="100px"></td>
                                            <td><?php echo $row['judul']; ?></td>
                                            <td><?php echo $row['gdrive']; ?></td>
                                            <td>
                                                <a href="hapus_portofolio.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Hapus</a>
                                            </td>
                                        <?php
                                        }
                                        ?>
